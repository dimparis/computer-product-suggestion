...
; (function ($, window, document, undefined) {
    ...
    daPickList.prototype = {
        defaults: {
            ...
            // List labels
            sourceListLabel: "Các tên gọi phụ",
            targetListLabel: "Tên gọi chính",
        ...
        _refresh: function () {
            var self = this;
            var addBtnEnabled = (self.targetList.children().length < self.config.selectLimit);
            ...
            if (self.sourceList.children(".pickList_selected").length && addBtnEnabled) {
